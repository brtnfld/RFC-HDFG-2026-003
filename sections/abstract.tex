...
from the filter-pipeline message, extending the version-3 record that
RFC-HDFG-2026-001 introduces for verbatim configuration-string storage
(folded into version~3 if the two RFCs ship in the same release,
otherwise as version~4); when a filter does not
